...
document.getElementById("player1_ne").innerHTML = player1_name + "  :  ";
document.getElementById("player2_ne").innerHTML = player2_name + "  :  ";
console.log(player1_name);
console.log(player2_name);
...
function send() {
    ...
    chartAt3 = word.charAt(length_divide_2);
